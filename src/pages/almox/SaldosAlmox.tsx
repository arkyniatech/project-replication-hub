...
import { Search, AlertTriangle, Minus, Plus, FileText } from "lucide-react";
...
export default function SaldosAlmox() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Saldos por Loja</h1>
        <p className="text-muted-foreground">
          Controle de saldos de estoque por item e loja
        </p>
      </div>
