...
DROP INDEX IF EXISTS public.idx_contratos_loja;
DROP INDEX IF EXISTS public.idx_contratos_cliente;
DROP INDEX IF EXISTS public.idx_contratos_obra;
DROP INDEX IF EXISTS public.idx_contratos_numero;
DROP INDEX IF EXISTS public.idx_contratos_status;
DROP INDEX IF EXISTS public.idx_contratos_data_inicio;
DROP INDEX IF EXISTS public.idx_contratos_data_fim;
DROP INDEX IF EXISTS public.idx_contrato_itens_contrato;
DROP INDEX IF EXISTS public.idx_contrato_itens_equipamento;
...
CREATE INDEX IF NOT EXISTS idx_contratos_obra_v2 ON public.contratos(obra_id);
CREATE INDEX IF NOT EXISTS idx_contratos_numero_v2 ON public.contratos(numero);
